...
const Room = (props: any) => {
  ...
  return (
    <group {...props} scale={2.4} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.23}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <mesh
            ...
            position={[-806.33, 147.05, 762.71]}
            rotation={[-Math.PI / 2, 1.4, 0]}
            scale={[80.68, 100, 99.46]}
          />
          <mesh
